    ...
    <div class="bd-example" >
        <div class="row">
            <div class="col-4 nav_left_col">
                <nav id="navbar-example3" class="vh-100 flex-column align-items-stretch pe-4 border-end nav_left_item" >
                    <nav class="nav nav-pills flex-column">
                        <a class="nav-link" href="#item-5">ПЛЕЙ-ОФФ 5-8</a>
                        <nav class="nav nav-pills flex-column">
            ...
            <div class="col-8 nav_right_col">
                <div class="nav_right_item" data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
                    @foreach($PlayOffs as $PlayOff)
                        <div id="item-5">
