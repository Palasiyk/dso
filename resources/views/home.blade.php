...
@section('content')
    ...
    <div class="container home_first">
        <div class="row">
            ...
            <div class="row next_game mb-3 ">
                <div class="col-5 text-center">
                    <img class="next_game_logo" src="../../images/logo/DSO.svg" alt="dso">
                </div>
                <div class="col-2 text-center">
                    <img class="next_game_logo" src="../../images/logo/vs.svg" alt="vs">
                </div>
                <div class="col-5 text-center">
                    <img class="next_game_logo" src="../../images/logo/epic.svg" alt="prom">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            {{--    VIDEO--}}
            <div class="row pb-3 mb-16 me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                <div class="row my-3 p-3">
                    <H2 class="text-center">Попередній матч</H2>
